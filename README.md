...
* **R1Soft Server Backup Manager (SBM)** - [Authentication Bypass](https://www.connectwise.com/platform/integrations/business-efficiency/r1soft) in latest version (reported)
